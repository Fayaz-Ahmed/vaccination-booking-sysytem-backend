...
public class UserValidation {
    ...
    public void validateMoh(String username) throws ChartVException {
        boolean valid = mohRepository.existsByUsername(username);
        System.out.println("test username :" + valid);
        if (valid) {
            throw new ChartVDataValidationException("Username Already Exists ", username);
        }
    ...
    public void validateMohEmail(String email) throws ChartVException {
        boolean valid = mohRepository.existsByEmail(email);
        System.out.println("test email: " + valid);
        if (valid) {
            throw new ChartVDataValidationException("Email Already Exists ", email);
        }
    ...
    public void validateMohNic(String nic) throws ChartVException {
        boolean valid = mohRepository.existsByNic(nic);
        System.out.println("test nic: " + valid);
        if (valid) {
            throw new ChartVDataValidationException("NIC Already Exists ", nic);
        }
